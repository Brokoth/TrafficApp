...
def roundabout(lane_1_density, lane_2_density, lane_3_density, lane_4_density,initial_path):
    rounda_model_url = \
...
def t_junction(lane_1_density, lane_2_density, lane_3_density,initial_path):
    tjun_model_url = \
