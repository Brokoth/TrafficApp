...
public class t_lane_3_add_thread extends Thread {
    public Handler handler;
    public int[] result;
    private String densityType, seconds;
    private String TAG = "t_lane_3_add_thread";
    private TextView con_lane_3, ai_lane_3;

    t_lane_3_add_thread(String seconds, String densityType, int[] result, TextView con_lane_3, TextView ai_lane_3) {
        this.seconds = seconds;
        this.densityType = densityType;
        this.result = result;
        this.con_lane_3 = con_lane_3;
