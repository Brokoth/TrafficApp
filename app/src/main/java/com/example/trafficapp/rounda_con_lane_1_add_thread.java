...
public class rounda_con_lane_1_add_thread extends Thread {
    int seconds;
    public Handler handler;
    private String densityType;
    private String TAG = "rounda_con_lane_1_add_thread";

    rounda_con_lane_1_add_thread(int seconds, String densityType) {
        this.seconds = seconds;
        this.densityType = densityType;
    }
