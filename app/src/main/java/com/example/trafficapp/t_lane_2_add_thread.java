...
public class t_lane_2_add_thread extends Thread {
    public Handler handler;
    public int[] result;
    private String densityType, seconds;
    private String TAG = "t_lane_2_add_thread";
    private TextView con_lane_2, ai_lane_2;

    t_lane_2_add_thread(String seconds, String densityType, int[] result, TextView con_lane_2, TextView ai_lane_2) {
        this.seconds = seconds;
        this.densityType = densityType;
        this.result = result;
        this.con_lane_2 = con_lane_2;
