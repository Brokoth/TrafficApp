...
public class rounda_efficiency_thread extends Thread {
    ...
    rounda_efficiency_thread(TextView ai_lane_1, TextView ai_lane_2, TextView ai_lane_3, TextView ai_lane_4, TextView con_lane_1, TextView con_lane_2, TextView con_lane_3, TextView con_lane_4, Context c, String simulationid, String userid,ProgressBar pbar) {
