...
public class rounda_efficiency_thread extends Thread {
    ...
    private static int ai_lane1_val_1, ai_lane2_val_1, ai_lane3_val_1, ai_lane4_val_1, ai_lane1_val_2, ai_lane2_val_2, ai_lane3_val_2, ai_lane4_val_2,
    ...
    public void run() {
        ...
        while (SimulationActivity.running) {
            ...
            int ai_lane_4_valchange = ai_lane4_val_2 - ai_lane4_val_1;
            ...
            int con_lane_4_valchange = con_lane4_val_2 - con_lane4_val_1;
            int average_ai_change = (ai_lane_1_valchange + ai_lane_2_valchange + ai_lane_3_valchange + ai_lane_4_valchange) / 4;
            ...
            int average_con_change = (con_lane_1_valchange + con_lane_2_valchange + con_lane_3_valchange + con_lane_4_valchange) / 4;
        ...
        db.collection("Users").document(userid).collection("Simulations").document(simulationid).
                update("ai_density_change_rate_coords", all_ai_coords, "ai_efficiency", String.valueOf(average_of_average_ai_rate),
                        "con_density_change_rate_coords", all_con_coords, "control_efficiency", String.valueOf(average_of_average_con_rate)).
                addOnSuccessListener(
                        new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(c, "Loaded simulation statistics", Toast.LENGTH_SHORT).show();
                            }
                        }
                ).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(c, "Failed to load simulation statistics", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
