...
public class rounda_lane_1_add_thread extends Thread {
    public Handler handler;
    public int[] result;
    private String densityType, seconds;
    private String TAG = "rounda_lane_1_add_thread";
    private TextView con_lane_1, ai_lane_1;

    rounda_lane_1_add_thread(String seconds, String densityType, int[] result, TextView con_lane_1, TextView ai_lane_1) {
        this.seconds = seconds;
        this.densityType = densityType;
        this.result = result;
        this.con_lane_1 = con_lane_1;
        ...
        if (SimulationActivity.running) {
            ...
            if (densityType.equals("Heavy Traffic")) {
                ...
                handler.post(new Runnable() {
                    @Override
                    public void run() {
                        con_lane_1.setText(String.valueOf(result[0]));
                        ai_lane_1.setText(String.valueOf(result[0]));
                    }
                });
                SystemClock.sleep(add_time);
                while (SimulationActivity.running) {
